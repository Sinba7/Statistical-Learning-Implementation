...
logo_header = html.Div(children=[
            ...
            html.Div([
                ...
                dbc.Alert(color='info', children="Hi, welcome to my movie store. To get movie recommendations, please select a recommender engine and input the required information. We will recommend some good movies based on your preference :).")
            ], style={'marginLeft':40}),
